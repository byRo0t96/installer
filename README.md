# installer
For install any script very easy :)
...
# How to get this app
```
git clone https://github.com/byRo0t96/installer.git
cd installer
```
...
bash installer.sh <OPTION>  # '-i' for install, '-u' for uninstall.
```

## Release History
```
[◉] Version 1.0.0 [27-08-2021]
[◉] Version 0.0.2 [27-01-2020]
[◉] Version 0.0.1 [22-01-2020]
...
```
...
<p align="center">
    ...
    <a align="center" href="https://github.com/yasserbdj96/" align="center">
        <img align="center" alt="" src="https://visitor-badge.laobi.icu/badge?page_id=yasserbdj96.yasserbdj96">
    </a>
</p>